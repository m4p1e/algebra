...
$$
\Sg(X) = \bigcap \Set{B \subseteq A}{X \subseteq B\ \text{and}\ B\ \text{is a subuniverse of}\ \mathbf{A}}.
$$ 
...
$$
思路是$\Sg(X) \subseteq X \cup E(X) \cup E^2(X) \cup \cdots$和$X \cup E(x) \cup E^2(X) \cup \cdots \subseteq \Sg(X)$.
\end{proof}
