...
\begin{proof}
$\slattice$有greatest element，则$A^u$肯定不是空了，至少这个greatest element里面. $\bigwedge A^u$就是要找$A^u$的lower upper bound，很显然这个greatest element就是的，因为你任取$a,b \in x \cap \uparrow y $，都有$a \leq 1$和$b \leq 1$，同时$1$也在$A^u$里面. 怎么感觉这个结论那个trivial呢(

还得proof一下这个是一个lattice，上面只是证明了这个东西是well behaved. Lattcie definition中前三条还是比较明显的.
$$
x \wedge (x \vee y) = x
$$
