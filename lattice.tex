...
{\color{blue} 就第四个在我们眼里似乎没有那么自然，它叫absorption laws(吸收律)，它在这里可以保证后面$\wedge$和$\vee$在相同的partial order下面. 前三个我们知道lattice同时在两种binary operator都是semilattice，所以我们只要在lattice上定义前面合适的partial order，它就是both meet and join semilattice}. 
